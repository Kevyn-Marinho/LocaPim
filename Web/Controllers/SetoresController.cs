...
namespace Web.Controllers
{
    public class SetoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdSetor,Nome,Descricao,Ativo")] Setor setor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdSetor,Nome,Descricao,Ativo")] Setor setor)
        {
            if (ModelState.IsValid)
            {
